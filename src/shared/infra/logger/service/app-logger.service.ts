...
import { initLogger } from '@src/shared/infra/logger/util/logger.factory';
...
export class AppLogger implements LoggerService {
  ...
  error(
    message: string,
    context: ContextType = {},
    defaultContext?: { originClass: string; originMethod: string }
  ) {
    const fields = defaultContext ?? this.getDefaultFields(context.exception);
