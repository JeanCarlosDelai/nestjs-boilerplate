...
import { PersistenceModule } from '@src/module/identity/persistance/persistence.module';
import { ConfigService } from '@src/shared/module/config/config.service';
import { TypeOrmMigrationService } from '@src/shared/module/persistance/typeorm/service/typeorm-migration.service';
...
const createDatabaseModule = async () => {
  return await NestFactory.createApplicationContext(
    PersistenceModule.forRoot({
      migrations: [__dirname + '/shared/module/persistance/typeorm/migration/*']
    })
  );
};
